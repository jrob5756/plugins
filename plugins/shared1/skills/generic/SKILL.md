...
description: |
  ...
  basic utility operations, or invokes shared1 by name.
  Triggers: time, what time, current time, utility, shared1.
---
...
- Always use the `shared1` subagent via the Task tool — never call MCP tools directly
